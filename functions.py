"""Linear approximation of Ramsey model.

This module contains functions to simulate a simple Ramsey
model with exogenous growth of technology and population.
...
def cal_steady_state(params):
    ...
    css_sharp = kss_sharp ** alpha - kss_sharp * (1.0 + g) * (1.0 + n) + \
        (1.0 - delta) * kss_sharp
...
def simulate_model(kss_sharp, css_sharp, params, T):
    """Get linear approximation result.
